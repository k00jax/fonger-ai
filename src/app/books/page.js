        ...
        <div className="grid grid-cols-1 gap-6 mb-16">
          ...
          <div className="group bg-[#0f0f0f] border border-[#1f1f1f] rounded-2xl p-8 card-hover transition-all duration-500">
            ...
            <a
              href="/wtfayta.md"
              download
              className="inline-flex items-center gap-2 mt-5 ml-3 px-5 py-2.5 border border-brand-red/30 text-brand-red text-sm rounded-lg font-medium hover:bg-brand-red/10 transition-all duration-300"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
